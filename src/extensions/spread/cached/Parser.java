package extensions.spread.cached;
...
public class Parser extends org.rascalmpl.parser.gtd.SGTDBF<IConstructor, IConstructor, ISourceLocation> {
  ...
  protected static IntegerMap _initDontNestGroups() {
    ...
    result.putUnsafe(4149, resultStoreId);
    ++resultStoreId;
    
    result.putUnsafe(5558, resultStoreId);
    ++resultStoreId;
    ...
    result.putUnsafe(4528, resultStoreId);
    ++resultStoreId;
  ...
  private static final IConstructor cHJvZChzb3J0KCJBcmdFeHByZXNzaW9uIiksW2xpdCgiLi4uIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLHNvcnQoIkV4cHJlc3Npb24iKV0se30p = (IConstructor) _read("prod(sort(\"ArgExpression\"),[lit(\"...\"),layouts(\"LAYOUTLIST\"),sort(\"Expression\")],{})", Factory.Production);
  ...
  protected static class Param {
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(3878, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(3875, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(3874, 1, , new int[] {115,111,114,116,40,34,80,97,114,97,109,34,41}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(3873, 0, new int[][]{{0,0}}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(3877, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(3876, 0, new int[][]{{48,57}}, null, null), true, null, null);
  ...
  protected static class RegularExpressionClass {
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(4008, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(4011, 4, new int[][]{{0,0}}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(4006, 0, new int[][]{{0,0}}, null, null);
      ...
      tmp[3] = new ListStackNode<IConstructor>(4010, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4009, 0, new int[][]{{48,57}}, null, null), true, null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIlJlZ3VsYXJFeHByZXNzaW9uQ2xhc3MiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDkxLDkxKV0pLFxpdGVyLXN0YXIobGV4KCJSZWd1bGFyRXhwcmVzc2lvbkNsYXNzQ2hhciIpKSxcY2hhci1jbGFzcyhbcmFuZ2UoOTMsOTMpXSldLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(4014, 0, new int[][]{{91,91}}, null, null);
      tmp[2] = new CharStackNode<IConstructor>(4017, 2, new int[][]{{93,93}}, null, null);
      tmp[1] = new ListStackNode<IConstructor>(4016, 1, cmVndWxhcihcaXRlci1zdGFyKGxleCgiUmVndWxhckV4cHJlc3Npb25DbGFzc0NoYXIiKSkp, new NonTerminalStackNode<IConstructor>(4015, 0, "RegularExpressionClassChar", null, null), false, null, null);
  ...
  protected static class Statement {
    ...
    protected static final void _init_cHJvZChsYWJlbCgiZXhwcmVzc2lvbiIsc29ydCgiU3RhdGVtZW50IikpLFtjb25kaXRpb25hbChzb3J0KCJFeHByZXNzaW9uIikse2V4Y2VwdCgiY2xhc3MiKSxleGNlcHQoImZ1bmN0aW9uIil9KSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCI7IildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new NonTerminalStackNode<IConstructor>(4150, 1, "layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4151, 2, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(4149, 0, "Expression", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new NonTerminalStackNode<IConstructor>(4155, 1, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4160, 5, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4162, 7, "layouts_LAYOUTLIST", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4157, 3, "layouts_LAYOUTLIST", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4169, 11, "layouts_LAYOUTLIST", null, null);
      tmp[8] = new LiteralStackNode<IConstructor>(4163, 8, cHJvZChsaXQoInsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDEyMywxMjMpXSldLHt9KQ0000, new int[] {123}, null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4161, 6, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4156, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[12] = new LiteralStackNode<IConstructor>(4170, 12, cHJvZChsaXQoIn0iKSxbXGNoYXItY2xhc3MoW3JhbmdlKDEyNSwxMjUpXSldLHt9KQ0000, new int[] {125}, null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(4158, 4, "Expression", null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4164, 9, "layouts_LAYOUTLIST", null, null);
      tmp[10] = new SeparatedListStackNode<IConstructor>(4167, 10, cmVndWxhcihcaXRlci1zdGFyLXNlcHMoc29ydCgiQ2FzZUNsYXVzZSIpLFtsYXlvdXRzKCJMQVlPVVRMSVNUIildKSk00, new NonTerminalStackNode<IConstructor>(4165, 0, "CaseClause", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(4166, 1, "layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4154, 0, , new int[] {115,119,105,116,99,104}, null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgiYnJlYWtOb0xhYmVsIixzb3J0KCJTdGF0ZW1lbnQiKSksW2xpdCgiYnJlYWsiKSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCI7IildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(4175, 2, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4173, 0, cHJvZChsaXQoImJyZWFrIiksW1xjaGFyLWNsYXNzKFtyYW5nZSg5OCw5OCldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTAxLDEwMSldKSxcY2hhci1jbGFzcyhbcmFuZ2UoOTcsOTcpXSksXGNoYXItY2xhc3MoW3JhbmdlKDEwNywxMDcpXSldLHt9KQ0000, new int[] {98,114,101,97,107}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[3] = new NonTerminalStackNode<IConstructor>(4181, 3, "layouts_LAYOUTLIST", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4190, 11, "layouts_LAYOUTLIST", null, null);
      tmp[13] = new NonTerminalStackNode<IConstructor>(4192, 13, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4185, 7, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4179, 1, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4183, 5, "layouts_LAYOUTLIST", null, null);
      tmp[8] = new LiteralStackNode<IConstructor>(4186, 8, cHJvZChsaXQoImluIiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMDUsMTA1KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTAsMTEwKV0pXSx7fSk00, new int[] {105,110}, null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(4182, 4, "Declarator", null, null);
      tmp[14] = new NonTerminalStackNode<IConstructor>(4193, 14, "Statement", null, null);
      tmp[12] = new LiteralStackNode<IConstructor>(4191, 12, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4180, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[6] = new NonTerminalStackNode<IConstructor>(4184, 6, "ForBinding", null, null);
      tmp[10] = new NonTerminalStackNode<IConstructor>(4188, 10, "Expression", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4178, 0, cHJvZChsaXQoImZvciIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMTAyLDEwMildKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTExLDExMSldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKV0se30p, new int[] {102,111,114}, null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4187, 9, "layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[8] = new NonTerminalStackNode<IConstructor>(4205, 8, "Statement", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4202, 5, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4197, 1, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4204, 7, "layouts_LAYOUTLIST", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4199, 3, "layouts_LAYOUTLIST", null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4206, 9, "layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4196, 0, cHJvZChsaXQoImlmIiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMDUsMTA1KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDIsMTAyKV0pXSx7fSk00, new int[] {105,102}, null, null);
      tmp[10] = new EmptyStackNode<IConstructor>(4209, 10, cmVndWxhcihlbXB0eSgpKQ0000, null, new ICompletionFilter[] {new StringFollowRestriction(new int[] {101,108,115,101})});
      tmp[2] = new LiteralStackNode<IConstructor>(4198, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4203, 6, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(4200, 4, "Expression", null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgiZGVidWdnZXIiLHNvcnQoIlN0YXRlbWVudCIpKSxbbGl0KCJkZWJ1Z2dlciIpLGxheW91dHMoIkxBWU9VVExJU1QiKSxsaXQoIjsiKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new NonTerminalStackNode<IConstructor>(4213, 1, "layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4212, 0, , new int[] {100,101,98,117,103,103,101,114}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4214, 2, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgiY29udGludWVOb0xhYmVsIixzb3J0KCJTdGF0ZW1lbnQiKSksW2xpdCgiY29udGludWUiKSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCI7IildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(4219, 2, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4217, 0, , new int[] {99,111,110,116,105,110,117,101}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4218, 1, "layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(4227, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4224, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(4222, 0, new int[][]{{0,0}}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(4226, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4225, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(4223, 1, , new int[] {115,111,114,116,40,34,83,116,97,116,101,109,101,110,116,34,41}, null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgiZW1wdHkiLHNvcnQoIlN0YXRlbWVudCIpKSxbbGl0KCI7IildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(4231, 0, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[16] = new NonTerminalStackNode<IConstructor>(4250, 16, "Statement", null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4243, 9, "layouts_LAYOUTLIST", null, null);
      tmp[10] = new LiteralStackNode<IConstructor>(4244, 10, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4234, 0, cHJvZChsaXQoInRyeSIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMTE2LDExNildKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTIxLDEyMSldKV0se30p, new int[] {116,114,121}, null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4240, 6, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(4236, 2, "Statement", null, null);
      tmp[14] = new LiteralStackNode<IConstructor>(4248, 14, , new int[] {102,105,110,97,108,108,121}, null, null);
      tmp[12] = new NonTerminalStackNode<IConstructor>(4246, 12, "Statement", null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(4238, 4, cHJvZChsaXQoImNhdGNoIiksW1xjaGFyLWNsYXNzKFtyYW5nZSg5OSw5OSldKSxcY2hhci1jbGFzcyhbcmFuZ2UoOTcsOTcpXSksXGNoYXItY2xhc3MoW3JhbmdlKDExNiwxMTYpXSksXGNoYXItY2xhc3MoW3JhbmdlKDk5LDk5KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDQsMTA0KV0pXSx7fSk00, new int[] {99,97,116,99,104}, null, null);
      tmp[8] = new NonTerminalStackNode<IConstructor>(4242, 8, "Id", null, null);
      tmp[15] = new NonTerminalStackNode<IConstructor>(4249, 15, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4241, 7, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4235, 1, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4239, 5, "layouts_LAYOUTLIST", null, null);
      tmp[13] = new NonTerminalStackNode<IConstructor>(4247, 13, "layouts_LAYOUTLIST", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4237, 3, "layouts_LAYOUTLIST", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4245, 11, "layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[9] = new NonTerminalStackNode<IConstructor>(4263, 9, "layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4253, 0, cHJvZChsaXQoImRvIiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMDAsMTAwKV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTEsMTExKV0pXSx7fSk00, new int[] {100,111}, null, null);
      tmp[10] = new LiteralStackNode<IConstructor>(4264, 10, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4259, 6, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(4255, 2, "Statement", null, null);
      tmp[12] = new LiteralStackNode<IConstructor>(4266, 12, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(4257, 4, cHJvZChsaXQoIndoaWxlIiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMTksMTE5KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDQsMTA0KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDUsMTA1KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDgsMTA4KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDEsMTAxKV0pXSx7fSk00, new int[] {119,104,105,108,101}, null, null);
      tmp[8] = new NonTerminalStackNode<IConstructor>(4261, 8, "Expression", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4258, 5, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4254, 1, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4260, 7, "layouts_LAYOUTLIST", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4256, 3, "layouts_LAYOUTLIST", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4265, 11, "layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[10] = new SeparatedListStackNode<IConstructor>(4287, 10, cmVndWxhcihcaXRlci1zdGFyLXNlcHMoc29ydCgiRXhwcmVzc2lvbiIpLFtsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCIsIiksbGF5b3V0cygiTEFZT1VUTElTVCIpXSkp, new NonTerminalStackNode<IConstructor>(4283, 0, "Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(4284, 1, "layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(4285, 2, cHJvZChsaXQoIiwiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQ0LDQ0KV0pXSx7fSk00, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(4286, 3, "layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4269, 0, cHJvZChsaXQoImZvciIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMTAyLDEwMildKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTExLDExMSldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKV0se30p, new int[] {102,111,114}, null, null);
      tmp[16] = new LiteralStackNode<IConstructor>(4299, 16, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4282, 9, "layouts_LAYOUTLIST", null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(4273, 4, "Declarator", null, null);
      tmp[14] = new SeparatedListStackNode<IConstructor>(4296, 14, cmVndWxhcihcaXRlci1zdGFyLXNlcHMoc29ydCgiRXhwcmVzc2lvbiIpLFtsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCIsIiksbGF5b3V0cygiTEFZT1VUTElTVCIpXSkp, new NonTerminalStackNode<IConstructor>(4292, 0, "Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(4293, 1, "layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(4294, 2, cHJvZChsaXQoIiwiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQ0LDQ0KV0pXSx7fSk00, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(4295, 3, "layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[12] = new LiteralStackNode<IConstructor>(4290, 12, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[18] = new NonTerminalStackNode<IConstructor>(4301, 18, "Statement", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4271, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[6] = new SeparatedListStackNode<IConstructor>(4279, 6, cmVndWxhcihcaXRlci1zZXBzKHNvcnQoIlZhcmlhYmxlRGVjbGFyYXRpb25Ob0luIiksW2xheW91dHMoIkxBWU9VVExJU1QiKSxsaXQoIiwiKSxsYXlvdXRzKCJMQVlPVVRMSVNUIildKSk00, new NonTerminalStackNode<IConstructor>(4275, 0, "VariableDeclarationNoIn", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(4276, 1, "layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(4277, 2, cHJvZChsaXQoIiwiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQ0LDQ0KV0pXSx7fSk00, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(4278, 3, "layouts_LAYOUTLIST", null, null)}, true, null, null);
      tmp[15] = new NonTerminalStackNode<IConstructor>(4298, 15, "layouts_LAYOUTLIST", null, null);
      tmp[8] = new LiteralStackNode<IConstructor>(4281, 8, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[17] = new NonTerminalStackNode<IConstructor>(4300, 17, "layouts_LAYOUTLIST", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4272, 3, "layouts_LAYOUTLIST", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4289, 11, "layouts_LAYOUTLIST", null, null);
      tmp[13] = new NonTerminalStackNode<IConstructor>(4291, 13, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4280, 7, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4274, 5, "layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgicmV0dXJuTm9FeHAiLHNvcnQoIlN0YXRlbWVudCIpKSxbbGl0KCJyZXR1cm4iKSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCI7IildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new NonTerminalStackNode<IConstructor>(4305, 1, "layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4306, 2, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4304, 0, , new int[] {114,101,116,117,114,110}, null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgidGhyb3dOb0V4cCIsc29ydCgiU3RhdGVtZW50IikpLFtsaXQoInRocm93IiksbGF5b3V0cygiTEFZT1VUTElTVCIpLGxpdCgiOyIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new NonTerminalStackNode<IConstructor>(4310, 1, "layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4311, 2, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4309, 0, cHJvZChsaXQoInRocm93IiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMTYsMTE2KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDQsMTA0KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTQsMTE0KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTEsMTExKV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTksMTE5KV0pXSx7fSk00, new int[] {116,104,114,111,119}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[7] = new NonTerminalStackNode<IConstructor>(4321, 7, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4319, 5, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4315, 1, "layouts_LAYOUTLIST", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4325, 11, "layouts_LAYOUTLIST", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4317, 3, "layouts_LAYOUTLIST", null, null);
      tmp[8] = new NonTerminalStackNode<IConstructor>(4322, 8, "Id", null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(4316, 2, "Statement", null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4320, 6, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(4318, 4, cHJvZChsaXQoImNhdGNoIiksW1xjaGFyLWNsYXNzKFtyYW5nZSg5OSw5OSldKSxcY2hhci1jbGFzcyhbcmFuZ2UoOTcsOTcpXSksXGNoYXItY2xhc3MoW3JhbmdlKDExNiwxMTYpXSksXGNoYXItY2xhc3MoW3JhbmdlKDk5LDk5KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDQsMTA0KV0pXSx7fSk00, new int[] {99,97,116,99,104}, null, null);
      tmp[12] = new NonTerminalStackNode<IConstructor>(4326, 12, "Statement", null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4323, 9, "layouts_LAYOUTLIST", null, null);
      tmp[10] = new LiteralStackNode<IConstructor>(4324, 10, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4314, 0, cHJvZChsaXQoInRyeSIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMTE2LDExNildKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTIxLDEyMSldKV0se30p, new int[] {116,114,121}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[3] = new NonTerminalStackNode<IConstructor>(4332, 3, "layouts_LAYOUTLIST", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4349, 11, "layouts_LAYOUTLIST", null, null);
      tmp[13] = new NonTerminalStackNode<IConstructor>(4356, 13, "layouts_LAYOUTLIST", null, null);
      ...
      tmp[7] = new NonTerminalStackNode<IConstructor>(4340, 7, "layouts_LAYOUTLIST", null, null);
      tmp[15] = new NonTerminalStackNode<IConstructor>(4358, 15, "layouts_LAYOUTLIST", null, null);
      tmp[8] = new SeparatedListStackNode<IConstructor>(4345, 8, cmVndWxhcihcaXRlci1zdGFyLXNlcHMoc29ydCgiRXhwcmVzc2lvbiIpLFtsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCIsIiksbGF5b3V0cygiTEFZT1VUTElTVCIpXSkp, new NonTerminalStackNode<IConstructor>(4341, 0, "Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(4342, 1, "layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(4343, 2, cHJvZChsaXQoIiwiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQ0LDQ0KV0pXSx7fSk00, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(4344, 3, "layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[4] = new SeparatedListStackNode<IConstructor>(4337, 4, cmVndWxhcihcaXRlci1zdGFyLXNlcHMoc29ydCgiRXhwcmVzc2lvbiIpLFtsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCIsIiksbGF5b3V0cygiTEFZT1VUTElTVCIpXSkp, new NonTerminalStackNode<IConstructor>(4333, 0, "Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(4334, 1, "layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(4335, 2, cHJvZChsaXQoIiwiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQ0LDQ0KV0pXSx7fSk00, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(4336, 3, "layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[12] = new SeparatedListStackNode<IConstructor>(4354, 12, cmVndWxhcihcaXRlci1zdGFyLXNlcHMoc29ydCgiRXhwcmVzc2lvbiIpLFtsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCIsIiksbGF5b3V0cygiTEFZT1VUTElTVCIpXSkp, new NonTerminalStackNode<IConstructor>(4350, 0, "Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(4351, 1, "layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(4352, 2, cHJvZChsaXQoIiwiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQ0LDQ0KV0pXSx7fSk00, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(4353, 3, "layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[14] = new LiteralStackNode<IConstructor>(4357, 14, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4331, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4339, 6, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[10] = new LiteralStackNode<IConstructor>(4348, 10, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4329, 0, cHJvZChsaXQoImZvciIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMTAyLDEwMildKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTExLDExMSldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKV0se30p, new int[] {102,111,114}, null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4347, 9, "layouts_LAYOUTLIST", null, null);
      tmp[16] = new NonTerminalStackNode<IConstructor>(4359, 16, "Statement", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[3] = new ListStackNode<IConstructor>(4366, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4365, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(4363, 1, , new int[] {92,105,116,101,114,45,115,116,97,114,40,115,111,114,116,40,34,83,116,97,116,101,109,101,110,116,34,41,41}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(4367, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4364, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(4362, 0, new int[][]{{0,0}}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[8] = new NonTerminalStackNode<IConstructor>(4382, 8, "Statement", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4376, 3, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4381, 7, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4379, 5, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4374, 1, "layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4373, 0, cHJvZChsaXQoIndoaWxlIiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMTksMTE5KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDQsMTA0KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDUsMTA1KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDgsMTA4KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDEsMTAxKV0pXSx7fSk00, new int[] {119,104,105,108,101}, null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(4377, 4, "Expression", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4375, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4380, 6, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgidGhyb3dFeHAiLHNvcnQoIlN0YXRlbWVudCIpKSxbbGl0KCJ0aHJvdyIpLGxheW91dHMoIkxBWU9VVExJU1QiKSxsYWJlbCgiZXhwcmVzc2lvbiIsc29ydCgiRXhwcmVzc2lvbiIpKSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCI7IildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[3] = new NonTerminalStackNode<IConstructor>(4389, 3, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4386, 1, "layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4385, 0, cHJvZChsaXQoInRocm93IiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMTYsMTE2KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDQsMTA0KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTQsMTE0KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTEsMTExKV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTksMTE5KV0pXSx7fSk00, new int[] {116,104,114,111,119}, null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(4390, 4, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(4387, 2, "Expression", null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgiYnJlYWtMYWJlbCIsc29ydCgiU3RhdGVtZW50IikpLFtsaXQoImJyZWFrIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLGxleCgiSWQiKSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCI7IildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(4393, 0, cHJvZChsaXQoImJyZWFrIiksW1xjaGFyLWNsYXNzKFtyYW5nZSg5OCw5OCldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTAxLDEwMSldKSxcY2hhci1jbGFzcyhbcmFuZ2UoOTcsOTcpXSksXGNoYXItY2xhc3MoW3JhbmdlKDEwNywxMDcpXSldLHt9KQ0000, new int[] {98,114,101,97,107}, null, null);
      ...
      tmp[2] = new NonTerminalStackNode<IConstructor>(4395, 2, "Id", null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgidmFyRGVjbCIsc29ydCgiU3RhdGVtZW50IikpLFtzb3J0KCJWYXJEZWNsIildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4400, 0, "VarDecl", null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgicmV0dXJuRXhwIixzb3J0KCJTdGF0ZW1lbnQiKSksW2xpdCgicmV0dXJuIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLGxhYmVsKCJleHAiLHNvcnQoIkV4cHJlc3Npb24iKSksbGF5b3V0cygiTEFZT1VUTElTVCIpLGxpdCgiOyIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(4403, 0, , new int[] {114,101,116,117,114,110}, null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(4408, 4, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(4405, 2, "Expression", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new NonTerminalStackNode<IConstructor>(4415, 4, "Expression", null, null);
      tmp[12] = new NonTerminalStackNode<IConstructor>(4424, 12, "Statement", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4413, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4418, 6, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4411, 0, cHJvZChsaXQoImlmIiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMDUsMTA1KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMDIsMTAyKV0pXSx7fSk00, new int[] {105,102}, null, null);
      tmp[10] = new LiteralStackNode<IConstructor>(4422, 10, cHJvZChsaXQoImVsc2UiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDEwMSwxMDEpXSksXGNoYXItY2xhc3MoW3JhbmdlKDEwOCwxMDgpXSksXGNoYXItY2xhc3MoW3JhbmdlKDExNSwxMTUpXSksXGNoYXItY2xhc3MoW3JhbmdlKDEwMSwxMDEpXSldLHt9KQ0000, new int[] {101,108,115,101}, null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4421, 9, "layouts_LAYOUTLIST", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4423, 11, "layouts_LAYOUTLIST", null, null);
      ...
      tmp[5] = new NonTerminalStackNode<IConstructor>(4417, 5, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4419, 7, "layouts_LAYOUTLIST", null, null);
      tmp[8] = new NonTerminalStackNode<IConstructor>(4420, 8, "Statement", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new NonTerminalStackNode<IConstructor>(4431, 4, "Expression", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4429, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4434, 6, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4427, 0, cHJvZChsaXQoIndpdGgiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDExOSwxMTkpXSksXGNoYXItY2xhc3MoW3JhbmdlKDEwNSwxMDUpXSksXGNoYXItY2xhc3MoW3JhbmdlKDExNiwxMTYpXSksXGNoYXItY2xhc3MoW3JhbmdlKDEwNCwxMDQpXSldLHt9KQ0000, new int[] {119,105,116,104}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4430, 3, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4433, 5, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4428, 1, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4435, 7, "layouts_LAYOUTLIST", null, null);
      tmp[8] = new NonTerminalStackNode<IConstructor>(4436, 8, "Statement", null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgiY29udGludWVMYWJlbCIsc29ydCgiU3RhdGVtZW50IikpLFtsaXQoImNvbnRpbnVlIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLGxleCgiSWQiKSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCI7IildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(4439, 0, , new int[] {99,111,110,116,105,110,117,101}, null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(4441, 2, "Id", null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(4443, 4, cHJvZChsaXQoIjsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU5LDU5KV0pXSx7fSk00, new int[] {59}, null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgiZnVuY3Rpb24iLHNvcnQoIlN0YXRlbWVudCIpKSxbc29ydCgiRnVuY3Rpb24iKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4446, 0, "Function", null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgiYmxvY2siLHNvcnQoIlN0YXRlbWVudCIpKSxbbGl0KCJ7IiksbGF5b3V0cygiTEFZT1VUTElTVCIpLFxpdGVyLXN0YXItc2Vwcyhzb3J0KCJTdGF0ZW1lbnQiKSxbbGF5b3V0cygiTEFZT1VUTElTVCIpXSksbGF5b3V0cygiTEFZT1VUTElTVCIpLGxpdCgifSIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(4449, 0, cHJvZChsaXQoInsiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDEyMywxMjMpXSldLHt9KQ0000, new int[] {123}, null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(4455, 4, cHJvZChsaXQoIn0iKSxbXGNoYXItY2xhc3MoW3JhbmdlKDEyNSwxMjUpXSldLHt9KQ0000, new int[] {125}, null, null);
      tmp[2] = new SeparatedListStackNode<IConstructor>(4453, 2, cmVndWxhcihcaXRlci1zdGFyLXNlcHMoc29ydCgiU3RhdGVtZW50IiksW2xheW91dHMoIkxBWU9VVExJU1QiKV0pKQ0000, new NonTerminalStackNode<IConstructor>(4451, 0, "Statement", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(4452, 1, "layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4454, 3, "layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[10] = new LiteralStackNode<IConstructor>(4470, 10, cHJvZChsaXQoIikiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQxLDQxKV0pXSx7fSk00, new int[] {41}, null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4458, 0, cHJvZChsaXQoImZvciIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMTAyLDEwMildKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTExLDExMSldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKV0se30p, new int[] {102,111,114}, null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(4469, 9, "layouts_LAYOUTLIST", null, null);
      tmp[12] = new NonTerminalStackNode<IConstructor>(4472, 12, "Statement", null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(4462, 4, "Expression", null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(4465, 6, cHJvZChsaXQoImluIiksW1xjaGFyLWNsYXNzKFtyYW5nZSgxMDUsMTA1KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSgxMTAsMTEwKV0pXSx7fSk00, new int[] {105,110}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4460, 2, cHJvZChsaXQoIigiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQwLDQwKV0pXSx7fSk00, new int[] {40}, null, null);
      tmp[8] = new NonTerminalStackNode<IConstructor>(4467, 8, "Expression", null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(4471, 11, "layouts_LAYOUTLIST", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4461, 3, "layouts_LAYOUTLIST", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(4466, 7, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4459, 1, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4464, 5, "layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgibGFiZWxlZCIsc29ydCgiU3RhdGVtZW50IikpLFtsZXgoIklkIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLGxpdCgiOiIpLGxheW91dHMoIkxBWU9VVExJU1QiKSxzb3J0KCJTdGF0ZW1lbnQiKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4475, 0, "Id", null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(4479, 4, "Statement", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4477, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgidHJ5RmluYWxseSIsc29ydCgiU3RhdGVtZW50IikpLFtsaXQoInRyeSIpLGxheW91dHMoIkxBWU9VVExJU1QiKSxzb3J0KCJTdGF0ZW1lbnQiKSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksbGl0KCJmaW5hbGx5IiksbGF5b3V0cygiTEFZT1VUTElTVCIpLHNvcnQoIlN0YXRlbWVudCIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(4482, 0, cHJvZChsaXQoInRyeSIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMTE2LDExNildKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTE0LDExNCldKSxcY2hhci1jbGFzcyhbcmFuZ2UoMTIxLDEyMSldKV0se30p, new int[] {116,114,121}, null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(4486, 4, , new int[] {102,105,110,97,108,108,121}, null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(4484, 2, "Statement", null, null);
      tmp[6] = new NonTerminalStackNode<IConstructor>(4488, 6, "Statement", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(4485, 3, "layouts_LAYOUTLIST", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(4487, 5, "layouts_LAYOUTLIST", null, null);
  ...
  protected static class LHSExpression {
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(4519, 0, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4521, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(4524, 4, new int[][]{{0,0}}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(4520, 1, , new int[] {115,111,114,116,40,34,76,72,83,69,120,112,114,101,115,115,105,111,110,34,41}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(4523, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4522, 0, new int[][]{{48,57}}, null, null), true, null, null);
  ...
  protected static class Literal {
    ...
    protected static final void _init_cHJvZChzb3J0KCJMaXRlcmFsIiksW2xleCgiU3RyaW5nIildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4540, 0, "String", null, null);
    ...
    protected static final void _init_cHJvZChzb3J0KCJMaXRlcmFsIiksW3NvcnQoIk51bWVyaWMiKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4542, 0, "Numeric", null, null);
    ...
    protected static final void _init_cHJvZChzb3J0KCJMaXRlcmFsIiksW2xpdCgibnVsbCIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(4548, 0, cHJvZChsaXQoIm51bGwiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDExMCwxMTApXSksXGNoYXItY2xhc3MoW3JhbmdlKDExNywxMTcpXSksXGNoYXItY2xhc3MoW3JhbmdlKDEwOCwxMDgpXSksXGNoYXItY2xhc3MoW3JhbmdlKDEwOCwxMDgpXSldLHt9KQ0000, new int[] {110,117,108,108}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(4556, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4553, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(4555, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4554, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(4552, 1, , new int[] {115,111,114,116,40,34,76,105,116,101,114,97,108,34,41}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(4551, 0, new int[][]{{0,0}}, null, null);
  ...
  protected static class ArgExpression {
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new LiteralStackNode<IConstructor>(4567, 1, , new int[] {115,111,114,116,40,34,65,114,103,69,120,112,114,101,115,115,105,111,110,34,41}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(4571, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4568, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(4570, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4569, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[0] = new CharStackNode<IConstructor>(4566, 0, new int[][]{{0,0}}, null, null);
    ...
    protected static final void _init_cHJvZChzb3J0KCJBcmdFeHByZXNzaW9uIiksW3NvcnQoIkV4cHJlc3Npb24iKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4574, 0, "Expression", null, null);
      builder.addAlternative(Parser.cHJvZChzb3J0KCJBcmdFeHByZXNzaW9uIiksW3NvcnQoIkV4cHJlc3Npb24iKV0se30p, tmp);
	}
    protected static final void _init_cHJvZChzb3J0KCJBcmdFeHByZXNzaW9uIiksW2xpdCgiLi4uIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLHNvcnQoIkV4cHJlc3Npb24iKV0se30p(ExpectBuilder<IConstructor> builder) {
      AbstractStackNode<IConstructor>[] tmp = (AbstractStackNode<IConstructor>[]) new AbstractStackNode[3];
      
      tmp[2] = new NonTerminalStackNode<IConstructor>(4578, 2, "Expression", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(4576, 0, cHJvZChsaXQoIi4uLiIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoNDYsNDYpXSksXGNoYXItY2xhc3MoW3JhbmdlKDQ2LDQ2KV0pLFxjaGFyLWNsYXNzKFtyYW5nZSg0Niw0NildKV0se30p, new int[] {46,46,46}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(4577, 1, "layouts_LAYOUTLIST", null, null);
      builder.addAlternative(Parser.cHJvZChzb3J0KCJBcmdFeHByZXNzaW9uIiksW2xpdCgiLi4uIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLHNvcnQoIkV4cHJlc3Npb24iKV0se30p, tmp);
	}
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(4586, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4583, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(4582, 1, , new int[] {92,105,116,101,114,45,115,116,97,114,45,115,101,112,115,40,115,111,114,116,40,34,65,114,103,69,120,112,114,101,115,115,105,111,110,34,41,44,91,108,105,116,40,34,44,34,41,93,41}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(4581, 0, new int[][]{{0,0}}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(4585, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4584, 0, new int[][]{{48,57}}, null, null), true, null, null);
    ...
    public static void init(ExpectBuilder<IConstructor> builder){
        ...
        _init_cHJvZChzb3J0KCJBcmdFeHByZXNzaW9uIiksW2xpdCgiLi4uIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLHNvcnQoIkV4cHJlc3Npb24iKV0se30p(builder);
  ...
  protected static class PropertyName {
    ...
    protected static final void _init_cHJvZChzb3J0KCJQcm9wZXJ0eU5hbWUiKSxbc29ydCgiTnVtZXJpYyIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4886, 0, "Numeric", null, null);
    ...
    protected static final void _init_cHJvZChzb3J0KCJQcm9wZXJ0eU5hbWUiKSxbbGV4KCJTdHJpbmciKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4888, 0, "String", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[3] = new ListStackNode<IConstructor>(4895, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4894, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(4892, 1, , new int[] {115,111,114,116,40,34,80,114,111,112,101,114,116,121,78,97,109,101,34,41}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(4896, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4893, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(4891, 0, new int[][]{{0,0}}, null, null);
    ...
    protected static final void _init_cHJvZChzb3J0KCJQcm9wZXJ0eU5hbWUiKSxbbGV4KCJJZCIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4899, 0, "Id", null, null);
  ...
  protected static class EscapeCharacter {
    ...
    protected static final void _init_cHJvZChsZXgoIkVzY2FwZUNoYXJhY3RlciIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMTE3LDExNykscmFuZ2UoMTIwLDEyMCldKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(4903, 0, new int[][]{{117,117},{120,120}}, null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIkVzY2FwZUNoYXJhY3RlciIpLFtsZXgoIlNpbmdsZUVzY2FwZUNoYXJhY3RlciIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(4905, 0, "SingleEscapeCharacter", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(4913, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(4910, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(4908, 0, new int[][]{{0,0}}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(4912, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(4911, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(4909, 1, , new int[] {115,111,114,116,40,34,69,115,99,97,112,101,67,104,97,114,97,99,116,101,114,34,41}, null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIkVzY2FwZUNoYXJhY3RlciIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoNDgsNTcpXSldLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(4916, 0, new int[][]{{48,57}}, null, null);
  ...
  protected static class CharacterEscapeSequence {
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new LiteralStackNode<IConstructor>(5034, 1, , new int[] {115,111,114,116,40,34,67,104,97,114,97,99,116,101,114,69,115,99,97,112,101,83,101,113,117,101,110,99,101,34,41}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5037, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5036, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5035, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIkNoYXJhY3RlckVzY2FwZVNlcXVlbmNlIiksW2xleCgiTm9uRXNjYXBlQ2hhcmFjdGVyIildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5041, 0, "NonEscapeCharacter", null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIkNoYXJhY3RlckVzY2FwZVNlcXVlbmNlIiksW2xleCgiU2luZ2xlRXNjYXBlQ2hhcmFjdGVyIildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5043, 0, "SingleEscapeCharacter", null, null);
  ...
  protected static class RegularExpressionChar {
    ...
    protected static final void _init_cHJvZChsZXgoIlJlZ3VsYXJFeHByZXNzaW9uQ2hhciIpLFtsZXgoIlJlZ3VsYXJFeHByZXNzaW9uQ2xhc3MiKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5147, 0, "RegularExpressionClass", null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIlJlZ3VsYXJFeHByZXNzaW9uQ2hhciIpLFtsZXgoIlJlZ3VsYXJFeHByZXNzaW9uQmFja3NsYXNoU2VxdWVuY2UiKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5149, 0, "RegularExpressionBackslashSequence", null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIlJlZ3VsYXJFeHByZXNzaW9uQ2hhciIpLFtcY2hhci1jbGFzcyhbcmFuZ2UoMSw5KSxyYW5nZSgxMSw0NikscmFuZ2UoNDgsOTApLHJhbmdlKDkzLDE2Nzc3MjE1KV0pXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(5151, 0, new int[][]{{1,9},{11,46},{48,90},{93,16777215}}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new LiteralStackNode<IConstructor>(5155, 1, , new int[] {92,105,116,101,114,45,115,116,97,114,40,115,111,114,116,40,34,82,101,103,117,108,97,114,69,120,112,114,101,115,115,105,111,110,67,104,97,114,34,41,41}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new LiteralStackNode<IConstructor>(5165, 1, , new int[] {115,111,114,116,40,34,82,101,103,117,108,97,114,69,120,112,114,101,115,115,105,111,110,67,104,97,114,34,41}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5168, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5167, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5166, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(5169, 4, new int[][]{{0,0}}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(5164, 0, new int[][]{{0,0}}, null, null);
  ...
  protected static class PropertyAssignment {
    ...
    protected static final void _init_cHJvZChsYWJlbCgicHJvcGVydHkiLHNvcnQoIlByb3BlcnR5QXNzaWdubWVudCIpKSxbc29ydCgiUHJvcGVydHlOYW1lIiksbGF5b3V0cygiTEFZT1VUTElTVCIpLGxpdCgiOiIpLGxheW91dHMoIkxBWU9VVExJU1QiKSxzb3J0KCJFeHByZXNzaW9uIildLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(5177, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(5179, 4, "Expression", null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(5175, 0, "PropertyName", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[3] = new ListStackNode<IConstructor>(5186, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5185, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[0] = new CharStackNode<IConstructor>(5182, 0, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5184, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5183, 1, , new int[] {115,111,114,116,40,34,80,114,111,112,101,114,116,121,65,115,115,105,103,110,109,101,110,116,34,41}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(5187, 4, new int[][]{{0,0}}, null, null);
    ...
    protected static final void _init_cHJvZChzb3J0KCJQcm9wZXJ0eUFzc2lnbm1lbnQiKSxbc29ydCgiTWV0aG9kRGVmaW5pdGlvbiIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5190, 0, "MethodDefinition", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(5195, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5197, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5196, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[4] = new CharStackNode<IConstructor>(5198, 4, new int[][]{{0,0}}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5194, 1, , new int[] {92,105,116,101,114,45,115,116,97,114,45,115,101,112,115,40,115,111,114,116,40,34,80,114,111,112,101,114,116,121,65,115,115,105,103,110,109,101,110,116,34,41,44,91,108,105,116,40,34,44,34,41,93,41}, null, null);
  ...
  protected static class Initializer {
    ...
    protected static final void _init_cHJvZChzb3J0KCJJbml0aWFsaXplciIpLFtsaXQoIj0iKSxsYXlvdXRzKCJMQVlPVVRMSVNUIiksc29ydCgiRXhwcmVzc2lvbiIpXSx7fSk00(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new NonTerminalStackNode<IConstructor>(5287, 2, "Expression", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(5285, 0, cHJvZChsaXQoIj0iKSxbXGNoYXItY2xhc3MoW3JhbmdlKDYxLDYxKV0pXSx7fSk00, new int[] {61}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(5286, 1, "layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(5290, 0, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5292, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(5295, 4, new int[][]{{0,0}}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5291, 1, , new int[] {115,111,114,116,40,34,73,110,105,116,105,97,108,105,122,101,114,34,41}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5294, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5293, 0, new int[][]{{48,57}}, null, null), true, null, null);
  ...
  protected static class LAYOUT {
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[1] = new LiteralStackNode<IConstructor>(5302, 1, , new int[] {115,111,114,116,40,34,76,65,89,79,85,84,34,41}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5305, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5304, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5303, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(5306, 4, new int[][]{{0,0}}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(5301, 0, new int[][]{{0,0}}, null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIkxBWU9VVCIpLFtsZXgoIldoaXRlc3BhY2UiKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5309, 0, "Whitespace", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(5317, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5314, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(5312, 0, new int[][]{{0,0}}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5316, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5315, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5313, 1, , new int[] {92,105,116,101,114,45,115,116,97,114,40,115,111,114,116,40,34,76,65,89,79,85,84,34,41,41}, null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIkxBWU9VVCIpLFtsZXgoIkNvbW1lbnQiKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5321, 0, "Comment", null, null);
  ...
  protected static class DecimalInteger {
    ...
    protected static final void _init_cHJvZChsZXgoIkRlY2ltYWxJbnRlZ2VyIiksW1xjaGFyLWNsYXNzKFtyYW5nZSg0OCw0OCldKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(5366, 0, new int[][]{{48,48}}, null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIkRlY2ltYWxJbnRlZ2VyIiksW1xjaGFyLWNsYXNzKFtyYW5nZSg0OSw1NyldKSxjb25kaXRpb25hbChcaXRlci1zdGFyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkse1xub3QtZm9sbG93KFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSl9KV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(5368, 0, new int[][]{{49,57}}, null, null);
      tmp[1] = new ListStackNode<IConstructor>(5372, 1, cmVndWxhcihcaXRlci1zdGFyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5369, 0, new int[][]{{48,57}}, null, null), false, null, new ICompletionFilter[] {new CharFollowRestriction(new int[][]{{48,57}})});
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(5380, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5377, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5379, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5378, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[0] = new CharStackNode<IConstructor>(5375, 0, new int[][]{{0,0}}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5376, 1, , new int[] {115,111,114,116,40,34,68,101,99,105,109,97,108,73,110,116,101,103,101,114,34,41}, null, null);
  ...
  protected static class VariableDeclarationNoIn {
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(5528, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(5531, 4, new int[][]{{0,0}}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(5526, 0, new int[][]{{0,0}}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5527, 1, , new int[] {115,111,114,116,40,34,86,97,114,105,97,98,108,101,68,101,99,108,97,114,97,116,105,111,110,78,111,73,110,34,41}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5530, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5529, 0, new int[][]{{48,57}}, null, null), true, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(5537, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      ...
      tmp[1] = new LiteralStackNode<IConstructor>(5536, 1, , new int[] {92,105,116,101,114,45,115,101,112,115,40,115,111,114,116,40,34,86,97,114,105,97,98,108,101,68,101,99,108,97,114,97,116,105,111,110,78,111,73,110,34,41,44,91,108,105,116,40,34,44,34,41,93,41}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5539, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5538, 0, new int[][]{{48,57}}, null, null), true, null, null);
    ...
    protected static final void _init_cHJvZChsYWJlbCgibm9uSW5pdCIsc29ydCgiVmFyaWFibGVEZWNsYXJhdGlvbk5vSW4iKSksW2xhYmVsKCJpZCIsbGV4KCJJZCIpKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5548, 0, "Id", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(5552, 0, "Id", null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(5558, 4, "Expression", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5555, 2, cHJvZChsaXQoIj0iKSxbXGNoYXItY2xhc3MoW3JhbmdlKDYxLDYxKV0pXSx7fSk00, new int[] {61}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(5556, 3, "layouts_LAYOUTLIST", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(5554, 1, "layouts_LAYOUTLIST", null, null);
  ...
  protected static class SingleStringChar {
    ...
    protected static final void _init_cHJvZChsZXgoIlNpbmdsZVN0cmluZ0NoYXIiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDEsOSkscmFuZ2UoMTEsMzgpLHJhbmdlKDQwLDkxKSxyYW5nZSg5MywxNjc3NzIxNSldKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(5677, 0, new int[][]{{1,9},{11,38},{40,91},{93,16777215}}, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(5680, 0, new int[][]{{0,0}}, null, null);
      tmp[4] = new CharStackNode<IConstructor>(5685, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5682, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5684, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5683, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5681, 1, , new int[] {115,111,114,116,40,34,83,105,110,103,108,101,83,116,114,105,110,103,67,104,97,114,34,41}, null, null);
    ...
    protected static final void _init_cHJvZChsZXgoIlNpbmdsZVN0cmluZ0NoYXIiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDkyLDkyKV0pLGxleCgiRXNjYXBlU2VxdWVuY2UiKV0se30p(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new CharStackNode<IConstructor>(5688, 0, new int[][]{{92,92}}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(5689, 1, "EscapeSequence", null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(5697, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5694, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5696, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5695, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[0] = new CharStackNode<IConstructor>(5692, 0, new int[][]{{0,0}}, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5693, 1, , new int[] {92,105,116,101,114,45,115,116,97,114,40,115,111,114,116,40,34,83,105,110,103,108,101,83,116,114,105,110,103,67,104,97,114,34,41,41}, null, null);
  ...
  protected static class Params {
    ...
    protected static final void _init_cHJvZChzb3J0KCJQYXJhbXMiKSxbbGFiZWwoImxzdCIsXGl0ZXItc3Rhci1zZXBzKHNvcnQoIlBhcmFtIiksW2xheW91dHMoIkxBWU9VVExJU1QiKSxsaXQoIiwiKSxsYXlvdXRzKCJMQVlPVVRMSVNUIildKSldLHt9KQ0000(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new SeparatedListStackNode<IConstructor>(5941, 0, cmVndWxhcihcaXRlci1zdGFyLXNlcHMoc29ydCgiUGFyYW0iKSxbbGF5b3V0cygiTEFZT1VUTElTVCIpLGxpdCgiLCIpLGxheW91dHMoIkxBWU9VVExJU1QiKV0pKQ0000, new NonTerminalStackNode<IConstructor>(5937, 0, "Param", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(5938, 1, "layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(5939, 2, cHJvZChsaXQoIiwiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDQ0LDQ0KV0pXSx7fSk00, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(5940, 3, "layouts_LAYOUTLIST", null, null)}, false, null, null);
    ...
    protected static final void _init_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new CharStackNode<IConstructor>(5950, 4, new int[][]{{0,0}}, null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(5947, 2, cHJvZChsaXQoIjoiKSxbXGNoYXItY2xhc3MoW3JhbmdlKDU4LDU4KV0pXSx7fSk00, new int[] {58}, null, null);
      tmp[0] = new CharStackNode<IConstructor>(5945, 0, new int[][]{{0,0}}, null, null);
      tmp[3] = new ListStackNode<IConstructor>(5949, 3, cmVndWxhcihpdGVyKFxjaGFyLWNsYXNzKFtyYW5nZSg0OCw1NyldKSkp, new CharStackNode<IConstructor>(5948, 0, new int[][]{{48,57}}, null, null), true, null, null);
      tmp[1] = new LiteralStackNode<IConstructor>(5946, 1, , new int[] {115,111,114,116,40,34,80,97,114,97,109,115,34,41}, null, null);
